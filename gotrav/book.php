...
<form action="book_form.php" method="post" class="book-form">
   ...
   <div class="flex">
      ...
      <div class="inputBox">
         <span>phone :</span>
         <input type="number" placeholder="enter your number" name="phone" required="" autocomplete="off">
      </div>
      <div class="inputBox">
         <span>address :</span>
      ...
      <div class="inputBox">
         <span>where to :</span>
         <input type="text" placeholder="place you want to visit" name="location" required="" autocomplete="off">
      </div>
      <div class="inputBox">
         <span>how many :</span>
         <input type="number" placeholder="number of guests" name="guests" required="" autocomplete="off">
      </div>
      <div class="inputBox">
         <span>arrivals :</span>
         <input type="date" name="arrivals" required="" autocomplete="off">
      </div>
      <div class="inputBox">
         <span>leaving :</span>
         <input type="date" name="leaving" required="" autocomplete="off">
      </div>
   </div>

   <button type="submit" value="submit" class="btn" name="submit">submit</button>
   <button type="submit" value="submit" class="btn"><a href="home.php">cancel</a></button>
